...
#
# Generated by Vivado on Fri Nov 26 08:05:22 +0530 2021
...
# Script info
echo -e "vio_0.sh - Script generated by export_simulation (Vivado v2016.4 (64-bit)-id)\n"
...
elaborate()
{
  $xv_path/bin/xelab --relax --debug typical --mt auto -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot vio_0 xil_defaultlib.vio_0 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  $xv_path/bin/xsim vio_0 -key {Behavioral:sim_1:Functional:vio_0} -tclbatch cmd.tcl -log simulate.log
}
